...
import {Button, Icon, Input, Avatar, Badge, ListItem, Divider} from 'react-native-elements';
import {
    Text,
    View,
    ActivityIndicator,
...
// const NAVIGATOR_HEIGHT = 50;
// const TAB_BAR_HEIGHT = 50;
// const { windowHeight, statusBarHeight, titleBarHeight } = info;
// const _scrollViewHeight = windowHeight - statusBarHeight - NAVIGATOR_HEIGHT - 12;
...
class Index extends Component {
            ...
            <TouchableOpacity onPress={() => this.gotoDetail(data.black_uid)}>
                ...
                <Text style={listItemStyle.timeText}>
                  {TimeUtils.getFormattedTime(data.created_at)}
                    ...
                    {/* <View style={{ justifyContent: 'center', height: 74 }}>
              <Icon
    ...
    _getBlackList = () => {
        this.page = 1;
        const that = this;
        api.getBlackList(this.page).then(function (message) {
            ...
            <SafeAreaView style={{flex: 1, backgroundColor: '#ffffff'}}>
                <Provider>
                    <View style={{flex: 1, backgroundColor: Global.pageBackgroundColor}}>
                        <CommonTitleBar title={'黑名单'} nav={this.props.navigation}/>
                        <RecyclerListView
                        ...
                        >
                            <View style={{flexDirection: 'row', justifyContent: 'center'}}>
                                <TextareaItem autoHeight count={100}
